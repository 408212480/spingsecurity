 ...
 * 
 */
package com.qunincey.brower.security.logout;
 ...
 *
 */
public class QunLogoutSuccessHandler implements LogoutSuccessHandler {

	private Logger logger = LoggerFactory.getLogger(getClass());

	public QunLogoutSuccessHandler(String signOutSuccessUrl) {
